          ...
          <FormControl fullWidth size="small">
            ...
            >
              ...
              <MenuItem value="backup">
                Backup{" "}
                {stats.byCategory?.backup && `(${stats.byCategory.backup})`}
              </MenuItem>
              <MenuItem value="dream_job">
                Dream Job{" "}
                {stats.byCategory?.dream_job &&
                  `(${stats.byCategory.dream_job})`}
              </MenuItem>
              <MenuItem value="applied">
                Applied{" "}
                {stats.byCategory?.applied && `(${stats.byCategory.applied})`}
              </MenuItem>
              <MenuItem value="rejected">
                Rejected{" "}
                {stats.byCategory?.rejected && `(${stats.byCategory.rejected})`}
              </MenuItem>
            </Select>
          </FormControl>
        </Grid>
          ...
          <FormControl fullWidth size="small">
            ...
            >
              ...
              <MenuItem value="medium">
                Medium{" "}
                {stats.byPriority?.medium && `(${stats.byPriority.medium})`}
              </MenuItem>
              <MenuItem value="low">
      ...
      <Box mt={2}>
        ...
        <Stack direction="row" spacing={1} flexWrap="wrap">
          ...
          <Chip
            ...
            onClick={() =>
              onFilterChange({
                ...filters,
                category:
                  filters.category === "dream_job" ? "all" : "dream_job",
              })
            }
            size="small"
          />
          <Chip
            ...
            clickable
            color={
              filters.applicationStatus === "not_applied"
                ? "warning"
                : "default"
            }
            onClick={() =>
          ...
          <Chip
            ...
            clickable
            color={
              filters.applicationStatus === "planning_to_apply"
                ? "info"
                : "default"
            }
            onClick={() =>
