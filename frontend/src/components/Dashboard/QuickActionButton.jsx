...
const QuickActionButton = ({ to, icon: Icon, label, variant = "outline" }) => {
  const baseStyles =
    "flex items-center gap-3 w-full px-4 py-3 rounded-xl font-medium transition-all duration-200 border";
  ...
  const variantStyles = {
    ...
    outline:
      "bg-transparent hover:bg-slate-700/50 text-slate-300 hover:text-white border-slate-600 hover:border-slate-500",
  };
