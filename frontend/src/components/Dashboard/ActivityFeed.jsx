...
const ActivityFeed = ({ maxItems = 10, companyId }) => {
    ...
    const renderActivity = (activity) => {
        const config = activityConfig[activity.type] || activityConfig.internship_viewed
        ...
        return (
            <div
                key={activity.id}
                className={`flex items-start gap-3 p-3 rounded-xl transition-all duration-300 ${activity.isNew
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <p className="text-sm text-slate-200">
                        ...
                        {' '}{config.label}{' '}
                        <span className="font-medium text-blue-400">{activity.internshipTitle}</span>
                    </p>
        ...
        <section className="bg-slate-800 rounded-xl shadow-md">
            ...
            <div className="flex items-center justify-between p-5 border-b border-slate-700">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className={`text-xs font-medium ${isLive ? 'text-green-400' : 'text-slate-500'}`}>
