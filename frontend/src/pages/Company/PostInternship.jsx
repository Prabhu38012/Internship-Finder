...
const PostInternship = () => {
  ...
  const validateForm = () => {
    ...
    if (
      dayjs(formData.startDate).isBefore(dayjs(formData.applicationDeadline))
    ) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const internshipData = {
        ...
        stipend: {
          ...
          amount: formData.stipend.amount
            ? parseFloat(formData.stipend.amount)
            : 0,
        },
        requirements: {
          ...formData.requirements,
          minCGPA: formData.requirements.minCGPA
            ? parseFloat(formData.requirements.minCGPA)
            : null,
        },
      ...
      setSuccess(
        "Internship posted successfully! Students will be notified in real-time.",
      );
        ...
        <Paper elevation={3} sx={{ p: 4 }}>
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" color="text.secondary">
              Create a new internship opportunity and reach thousands of
              talented students instantly
            </Typography>
          </Box>
